                    ...
                    <div class="tab-content" id="tabdados_ponto">
                        ...
                        <div class="tab-pane fade" id="complemento_ponto" role="tabpanel" aria-labelledby="complemento_ponto">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="valor_duracao_ponto" name="valor_duracao_ponto" maxlength="100">
                            </div>
                             <div class="col-md-6">
                                <label for="rel_contato_ponto" class="form-label">Relação de Contato</label>
                                <input type="text" class="form-control" id="rel_contato_ponto" name="rel_contato_ponto" maxlength="100">
                            </div>
                            <div class="col-md-6">
