                    ...
                    <div class="tab-content" id="tabdados_ponto">
                        ...
                        <div class="tab-pane fade" id="complemento_ponto" role="tabpanel" aria-labelledby="complemento_ponto">
                            ...
                            <div class="col-md-6">
                             ...
                             <!--Facrof-->
                             <div class="col-md-6">
                                <label for="valor_relacao_ponto" class="form-label">Relação</label>
                                <input type="text" class="form-control" id="valor_relacao_ponto" name="valor_relacao_ponto" maxlength="100">
                            </div>

                            <div class="col-md-6">
                                <label for="duracao_ponto" class="form-label">Duração</label>
                                <input type="text" class="form-control" id="duracao_ponto" name="duracao_ponto" maxlength="100">
                            </div>
