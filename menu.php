          ...
          <div class="row">
            ...
            <div class="col-md-4 d-flex justify-content-center">
              <div class="row">
                ...
                <div class="col-md-12">
                  <label for="corrente" class="form-label">Corrente</label>
                  <select name="corrente" id="corrente" class="form-select">
                    <?php
                    $correntes = listarCorrente();
                    echo"<option value=''></option>";
                    foreach ($correntes as $corrente) {
                      echo "<option value='" . $corrente["valor_corrente"] . "'>" . $corrente["valor_corrente"] . "</option>";
                    }                    
                    ?>
                  </select>
                  <label for="relacao" class="form-label">Relação</label>
                  <select name="relacao" id="relacao" class="form-select">
                  
                    <?php
                    $relacoes = listarRelacao();    
                    echo"<option value=''></option>";               
                    foreach ($relacoes as $relacao) {
                      echo  "<option value='" . $relacao["valor_relacao"] . "'>" . $relacao["valor_relacao"] . "</option>";
                    } 
                    ?>
                  </select>
                  <br>
