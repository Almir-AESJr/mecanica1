    ...
    switch ($_POST["acao"]) {
        case "adicionar":
            try {
                ...
                $sql = "insert into ponto(valor_corrente, duracao, rel_contato, valor_desgaste, valor_remocao, valor_rugosidade, polaridade, eletrodo_id, operacao_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ";
                $conexao = new PDO("mysql:host=" . SERVIDOR . ";dbname=" . BANCO, USUARIO, SENHA);
                $pre = $conexao->prepare($sql);
                $pre->execute(array(
                    $registro->valor_corrente_ponto,
                    $registro->valor_duracao_ponto,
                    $registro->rel_contato_ponto,
        ...
        case "editar":
            try {
                ...
                $sql = "update ponto set valor_corrente = ?, duracao = ?, rel_contato = ?, valor_desgaste = ?, valor_remocao = ?, valor_rugosidade = ?, polaridade = ?, eletrodo_id = ?, operacao_id = ? where id = ? ";
                $conexao = new PDO("mysql:host=" . SERVIDOR . ";dbname=" . BANCO, USUARIO, SENHA);
                $pre = $conexao->prepare($sql);
                $pre->execute(array(
                    $registro->valor_corrente_ponto,
