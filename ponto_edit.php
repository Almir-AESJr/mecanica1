                ...
                <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="ponto_dados" role="form" action="">
                    ...
                    <div class="tab-content" id="tabdados_ponto">
                        <div class="tab-pane fade show active" id="dados_ponto" role="tabpanel" aria-labelledby="dados_ponto">
                            ...
                            <div class="col-md-6">
                                <label for="polaridade_ponto" class="form-label">Polaridade</label><select name="polaridade_ponto" id="polaridade_ponto" class="form-select">
                                    <?php
                        ...
                        <div class="tab-pane fade" id="complemento_ponto" role="tabpanel" aria-labelledby="complemento_ponto">
                            ...
                            <!--Facrof-->
                            <div class="col-md-6">
                                <label for="valor_relacao_ponto" class="form-label">Valor Relação</label>
                                <input type="text" class="form-control" id="valor_relacao_ponto" name="valor_relacao_ponto" maxlength="100" value="<?php echo isset($resultado['valor_relacao']) ?  str_replace(".", ",", $resultado["valor_relacao"]) : ''; ?>">
                            </div>

                            <div class="col-md-6">
                                <label for="duracao_ponto" class="form-label">Valor Relação</label>
                                <input type="text" class="form-control" id="duracao_ponto" name="duracao_ponto" maxlength="100" value="<?php echo isset($resultado['duracao_ponto']) ?  str_replace(".", ",", $resultado["duracao_ponto"]) : ''; ?>">
                            </div>
