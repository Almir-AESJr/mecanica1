                ...
                <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="ponto_dados" role="form" action="">
                    ...
                    <div class="tab-content" id="tabdados_ponto">
                        ...
                        <div class="tab-pane fade" id="complemento_ponto" role="tabpanel" aria-labelledby="complemento_ponto">
                            ...
                            <div class="col-md-6">
                                <label for="valor_duracao_ponto" class="form-label">Duração</label>
                                <input type="text" class="form-control" id="valor_duracao_ponto" name="valor_duracao_ponto" maxlength="100" value="<?php echo isset($resultado['duracao']) ? str_replace(".", ",", $resultado["duracao"]) : ''; ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="rel_contato_ponto" class="form-label">Relação de Contato</label>
                                <input type="text" class="form-control" id="rel_contato_ponto" name="rel_contato_ponto" maxlength="100" value="<?php echo isset($resultado['rel_contato']) ? str_replace(".", ",", $resultado["rel_contato"]) : ''; ?>">
                            </div>
                            <div class="col-md-6">
